...
function Navbar() {
  return (
    <nav className="flex items-center px-1 md:p-6 p-6">
      ...
      <Link to="achievements" className="hideoverlay">
        <button className="nav--achievements text-lg md:text-2xl font-extrabold border-2 border-white-400 backdrop-filter backdrop-blur-sm bg-black bg-opacity-10 rounded-xl p-2 sm:p-4 mr-4 ml-4 transition hover:scale-105">
